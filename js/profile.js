...
import { state } from "./state.js?v=0.18.9";
...
const ENTRANCE_PYRO_PRESETS = {
  ...
  cross_x:{tier:"rare",name:"Crossing X Jets",config:{preset:"cross_x",enabled:true,style:"cross_jets",position:"both",color:"#FFFFFF",duration:3.2,frequency:1.3,height:.78,width:1.2,intensity:2,burstCount:1,behavior:"simultaneous",flashBurst:true,layeredEffects:false}},
...
const ENTRANCE_TEMPLATES = {
  ...
  rare_green_rebellion: { tier:"rare", name:"Rare — Green Rebellion", config:{ enabled:true, pyro:{preset:"cross_x",enabled:true,style:"cross_jets",position:"both",color:"#22C55E",duration:3.2,frequency:1.3,height:.78,width:1.2,intensity:2,burstCount:1,behavior:"simultaneous",flashBurst:true}, atmosphere:{type:"none"}, lighting:{enabled:true,dimming:"strong",blackout:false,spotlight:false,phoneLights:false,lightning:false,primaryColor:"#22C55E",secondaryColor:"#FFFFFF",motion:"fan",speed:.8,brightness:.76,beamWidth:1.2,fixtureCount:6}, filter:{mode:"none",intensity:0}, screenFx:{effect:"none"}, nameplate:{enabled:true,style:"neon",glow:true,animation:"fade"}, timing:{totalDuration:7} } },
