import { APP_VERSION } from "./config.js?v=0.18.13";
...
import {
  ...
  closeMemberDialog
} from "./admin.js?v=0.18.13";
import {
  initChatUI,
  enterChatroom,
  closeChatSocket
} from "./chat.js?v=0.18.13";
import { initThemeSystem } from "./themes.js?v=0.18.13";
import { initProfiles } from "./profile.js?v=0.18.13";
