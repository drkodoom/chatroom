import { APP_VERSION } from "./config.js?v=0.16.3";
...
import {
  ...
  closeMemberDialog
} from "./admin.js?v=0.16.3";
import {
  initChatUI,
  enterChatroom,
  closeChatSocket
} from "./chat.js?v=0.16.3";
import { initThemeSystem } from "./themes.js?v=0.16.3";
import { initProfiles } from "./profile.js?v=0.16.3";
