import { APP_VERSION } from "./config.js?v=0.18.9";
...
import {
  ...
  closeMemberDialog
} from "./admin.js?v=0.18.9";
import {
  initChatUI,
  enterChatroom,
  closeChatSocket
} from "./chat.js?v=0.18.9";
import { initThemeSystem } from "./themes.js?v=0.18.9";
import { initProfiles } from "./profile.js?v=0.18.9";
