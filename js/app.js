import { APP_VERSION } from "./config.js?v=0.18.8";
...
import {
  ...
  closeMemberDialog
} from "./admin.js?v=0.18.8";
import {
  initChatUI,
  enterChatroom,
  closeChatSocket
} from "./chat.js?v=0.18.8";
import { initThemeSystem } from "./themes.js?v=0.18.8";
import { initProfiles } from "./profile.js?v=0.18.8";
