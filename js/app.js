import { APP_VERSION } from "./config.js?v=0.17.0";
...
import {
  ...
  closeMemberDialog
} from "./admin.js?v=0.17.0";
import {
  initChatUI,
  enterChatroom,
  closeChatSocket
} from "./chat.js?v=0.17.0";
import { initThemeSystem } from "./themes.js?v=0.17.0";
import { initProfiles } from "./profile.js?v=0.17.0";
